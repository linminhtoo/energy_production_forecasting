...
class LSTM_CNN_concat(nn.Module): 
    def __init__(self, input_shape, class_size,
        ...
        super(LSTM_CNN_concat, self).__init__()
    ...
    def forward(self, input): 
        cnn_out = self.cnn_model(input.transpose(1,2))
